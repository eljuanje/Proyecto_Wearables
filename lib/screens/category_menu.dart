          ...
          Padding(
            ...
            child: Center(
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    soundBtn('corridos', context),
                    soundBtn('norteno', context),
                    soundBtn('rap', context),
                    soundBtn('pop', context),
                    SizedBox(
                      height: 40,
                    ),
                  ],
